...
function on_msg_receive (msg)
  ...
  if (msg.text == 'ls') then
    send_msg (msg.from.print_name, 'kommt sofort kleiner...', ok_cb, false)
  ...
  elseif(msg.text == 'playlist') then
    ...
    return
  elseif(msg.text == 'wasndasn') then
    send_msg (msg.from.print_name, 'du otto hast ja keine ahnung von musik', ok_cb, false)
    os.execute("/home/pi/sendTelegram.sh "..msg.from.print_name.." /home/pi/currentsong.txt")
    return
  ...
  elseif(msg.text == 'photos') then
    send_msg (msg.from.print_name, 'licht aus glotze an', ok_cb, false)
    os.execute("sudo killall fbi; sudo fbi -d /dev/fb0 -u -T 1 -t 10 -a -noverbose /home/pi/.telegram-cli/downloads/*")
    return
